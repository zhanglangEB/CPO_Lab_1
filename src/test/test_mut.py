...
class TestMutableList(unittest.TestCase):
    ...
    def test_monoid_associativity(self, a, b, c):
        ...
        tmp1=test.mconcat(lst.mconcat(lst1, lst2), lst3).to_list()
        tmp2=test.mconcat(lst1, lst.mconcat(lst2, lst3)).to_list()
        self.assertEqual(tmp1,tmp2)
        #self.assertEqual(id(tmp1),id(tmp2))
